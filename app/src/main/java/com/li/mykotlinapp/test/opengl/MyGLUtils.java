...
//        Matrix.rotateM(modelMatrix, 0, mRotateAgree, 0, -1, 0); //获取模型旋转变换矩阵
        Matrix.rotateM(modelMatrix, 0, angle, 0, -1, 0); //获取模型旋转变换矩阵
//        Matrix.setLookAtM(viewMatrix, 0, 0, 5, 10, 0, 0, 0, 0, 1, 0); //获取观测变换矩阵
        Matrix.setLookAtM(viewMatrix, 0, 0, 3, 10, 0, 0, 0, 0, 1, 0); //获取观测变换矩阵
