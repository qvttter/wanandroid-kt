...
import static com.li.mykotlinapp.test.calypso.command.sam.SamRevision.AUTO;
import java.util.*;
import java.util.regex.Pattern;
import com.li.mykotlinapp.test.calypso.exception.CalypsoNoSamResourceAvailableException;
import com.li.mykotlinapp.test.core.selection.SeSelection;
import com.li.mykotlinapp.test.core.selection.SelectionsResult;
import com.li.mykotlinapp.test.core.seproxy.*;
import com.li.mykotlinapp.test.core.seproxy.event.ObservablePlugin;
import com.li.mykotlinapp.test.core.seproxy.event.ObservableReader;
import com.li.mykotlinapp.test.core.seproxy.event.PluginEvent;
import com.li.mykotlinapp.test.core.seproxy.event.ReaderEvent;
