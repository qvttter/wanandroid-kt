...
import com.li.mykotlinapp.test.calypso.command.po.parser.security.OpenSession32RespPars;
...
public final class OpenSession32CmdBuild
    ...
    public OpenSession32CmdBuild(byte keyIndex, byte[] samChallenge, byte sfiToSelect,
        ...
        this.request = setApduRequest(PoClass.ISO.getValue(),
                CalypsoPoCommands.getOpenSessionForRev(PoRevision.REV3_2), p1, p2, dataIn, le);
        if (extraInfo != null) {
