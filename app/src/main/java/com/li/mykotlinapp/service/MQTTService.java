...
public class MQTTService extends Service {
    ...
    private String host = "tcp://10.100.103.31:31035";
    private String userName = "DXA1OkewkkGIfcAa6Dpz";
    private String passWord = "";
    private static String myTopic = "v1/devices/me/telemetry";      //要订阅的主题
    private String clientId = "398130c0-e12c-11ea-9711-79ed7faeb276";//客户端标识
    ...
    private MqttCallback mqttCallback = new MqttCallback() {
        ...
        public void messageArrived(String topic, MqttMessage message) throws Exception {
            ...
            LiveEventBus.get(Constants.MQTT_MSG).post(new MQTTBus(str1));
